...
(function ( exports, $ ) {
    ...
    */
    ...
    $.each(
        [ 'html', 'val' ], function ( index, method ) {
    ...
    initialize: function ( params, options ) {
        ...
        this.add('origin', this.url()).link(this.url).setter(
        function ( to ) {
    ...
    render: function () {
        ...
        if (notification.dismissible ) {
            container.find('.notice-dismiss').on(
    ...
    api.utils.parseQueryString = function parseQueryString( queryString )
    {
        var queryParams = {};
        _.each(
            queryString.split('&'), function ( pair ) {
                var parts, key, value;
                parts = pair.split('=', 2);
                if (! parts[0] ) {
                    return;
