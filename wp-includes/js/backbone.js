...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(
            ['underscore', 'jquery', 'exports'], function (_, $, exports) {
    ...
    function (root, Backbone, _, $) {
        ...
        Events.on = function (name, callback, context) {
            this._events = eventsApi(
                onApi, this._events || {}, name, callback, {
                    context: context,
                    ctx: this,
        ...
        var addUnderscoreMethods = function (Class, base, methods, attribute) {
            _.each(
                methods, function (length, method) {
        ...
        [Model, modelMethods, 'attributes']
            ...
            Base.mixin = function (obj) {
                var mappings = _.reduce(
                    _.functions(obj), function (memo, name) {
                        memo[name] = 0;
                        return memo;
                    }, {}
                );
    ...
    _.extend(
        Router.prototype, Events, {
            ...
            _routeToRegExp: function (route) {
                ...
                .replace(
                    namedParam, function (match, optional) {
