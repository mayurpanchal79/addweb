...
final class WP_Customize_Manager
{
    ...
    public function __construct( $args = array() )
    {
        ...
        include_once ABSPATH . WPINC . '/class-wp-customize-setting.php';
        include_once ABSPATH . WPINC . '/class-wp-customize-panel.php';
        include_once ABSPATH . WPINC . '/class-wp-customize-section.php';
        include_once ABSPATH . WPINC . '/class-wp-customize-control.php';

        include_once ABSPATH . WPINC . '/customize/class-wp-customize-color-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-media-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-upload-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-image-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-background-image-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-background-position-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-cropped-image-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-site-icon-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-header-image-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-theme-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-code-editor-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-widget-area-customize-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-widget-form-customize-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menu-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menu-item-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menu-location-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menu-name-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menu-locations-control.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menu-auto-add-control.php';

        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menus-panel.php';

        include_once ABSPATH . WPINC . '/customize/class-wp-customize-themes-panel.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-themes-section.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-sidebar-section.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menu-section.php';

        include_once ABSPATH . WPINC . '/customize/class-wp-customize-custom-css-setting.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-filter-setting.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-header-image-setting.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-background-image-setting.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menu-item-setting.php';
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-nav-menu-setting.php';
        ...
        include_once ABSPATH . WPINC . '/customize/class-wp-customize-selective-refresh.php';
        $this->selective_refresh = new WP_Customize_Selective_Refresh($this);

        if (in_array('widgets', $components, true) ) {
            include_once ABSPATH . WPINC . '/class-wp-customize-widgets.php';
            $this->widgets = new WP_Customize_Widgets($this);
        }

        if (in_array('nav_menus', $components, true) ) {
            include_once ABSPATH . WPINC . '/class-wp-customize-nav-menus.php';
...
*/
    ...
    public function check_changeset_lock_with_heartbeat( $response, $data, $screen_id )
    {
        ...
        if (array_key_exists('check_changeset_lock', $data)
            && 'customize' === $screen_id
            && $changeset_post_id
