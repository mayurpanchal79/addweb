 ...
 *                                 If you start the name with an underscore the order will be reversed. You can also specify 'rand' as the order
 ...
 *                          Or maybe owner. If you start the name with an underscore the order will be reversed.
 ...
 *                          'description', or 'rating'. Or maybe owner. If you start
 *                          the name with an underscore the order will be reversed.
 *                          You can also specify 'rand' as the order which will
 *                          return links in a random order.                        
 * @param  int    $limit    Limit to X entries. If not specified, all entries are shown.
 * @return array
 */
...
function list_cats($optionall = 1, $all = 'All', $sort_column = 'ID', $sort_order = 'asc', $file = '', $list = true, $optiondates = 0,
    ...
    $query = compact(
        'optionall', 'all', 'sort_column', 'sort_order', 'file', 'list', 'optiondates', 'optioncount', 'hide_empty', 'use_desc_for_title', 'children',
...
function dropdown_cats($optionall = 1, $all = 'All', $orderby = 'ID', $order = 'asc',
    ...
    $vars = compact(
        'show_option_all', 'show_option_none', 'orderby', 'order',
