...
describe(
    'getQuery', () => {
        describe(
        'per_page calculations', () => {
                test(
                'should set per_page as a result of row * col', () => {
                        let query = getQuery(
                        {
                                columns: 4,
                                rows: 3,
        ...
        test(
                'should restrict per_page to under 100', () => {
                let query = getQuery(
                        {
                        columns: 4,
                        rows: 30,
    ...
    describe(
        ...
        test(
                'should order by date when using "date"', () => {
        ...
        test(
            'should order by price, DESC when "price_desc"', () => {
        ...
        test(
            'should order by price, ASC when "price_asc"', () => {
        ...
        test(
            'should order by title, ASC when "title"', () => {
        ...
        test(
            'should order by menu_order, ASC when "menu_order"', () => {
        ...
        test(
            'should order by popularity when "popularity"', () => {
    ...
    describe(
        ...
        test(
                'should return a general query with no category', () => {
                const query = getQuery(attributes);
        ...
        test(
            'should return an empty category query', () => {
        ...
        test(
            'should return a category query with one category', () => {
        ...
        test(
            'should return a category query with two categories', () => {
