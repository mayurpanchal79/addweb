...
describe(
    ...
    test(
        'should render nodes as the text', () => {
    ...
    test(
        'should render screen reader text', () => {
        const component = TestRenderer.create(
    ...
    describe(
        'with custom wrapper', () => {
        test(
                'should render a chip made up of a div instead of a li', () => {
                const component = TestRenderer.create(
...
describe(
    'RemovableChip', () => {
    test(
            'should render text and the remove button', () => {
            const component = TestRenderer.create(<RemovableChip text="Test" />);
            expect(component.toJSON()).toMatchSnapshot();
            } 
        );
    test(
        'should render with disabled remove button', () => {
        const component = TestRenderer.create(
    ...
    test(
        'should render custom aria label', () => {
        const component = TestRenderer.create(
    ...
    test(
        'should render default aria label if text is a node', () => {
        const component = TestRenderer.create(
    ...
    test(
        'should render screen reader text aria label', () => {
        const component = TestRenderer.create(
    ...
    describe(
        'with removeOnAnyClick', () => {
        test(
                'should be a button when removeOnAnyClick is set to true', () => {
                const component = TestRenderer.create(
