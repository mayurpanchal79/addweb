...
class FeaturePlugin
{
    ...
    public function init()
    {
        ...
        include_once WC_ADMIN_ABSPATH . '/includes/core-functions.php';
        include_once WC_ADMIN_ABSPATH . '/includes/feature-config.php';
        include_once WC_ADMIN_ABSPATH . '/includes/page-controller-functions.php';
        include_once WC_ADMIN_ABSPATH . '/includes/wc-admin-update-functions.php';
