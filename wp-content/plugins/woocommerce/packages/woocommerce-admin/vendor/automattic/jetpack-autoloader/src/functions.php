...
function autoloader( $class_name )
{
    ...
    if (isset($jetpack_packages_classmap[ $class_name ]) ) {
        include_once $jetpack_packages_classmap[ $class_name ]['path'];
        return true;
    }
...
{
    include_once __DIR__ . '/../class-classes-handler.php';
    include_once __DIR__ . '/../class-files-handler.php';
...
function set_up_autoloader()
{
    ...
    include_once __DIR__ . '/../class-plugins-handler.php';
    include_once __DIR__ . '/../class-version-selector.php';
    include_once __DIR__ . '/../class-autoloader-handler.php';
