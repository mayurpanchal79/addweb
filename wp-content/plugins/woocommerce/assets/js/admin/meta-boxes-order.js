...
jQuery(
    function ( $ ) {
        ...
        var wc_meta_boxes_order = {
            states: null,
            init: function () {
                if (! (        typeof woocommerce_admin_meta_boxes_order === 'undefined' 
                ...
                $('#woocommerce-order-actions input, #woocommerce-order-actions a').click(
                    function () {
                        ...
                        $.ajax(
                            {
                                ...
                                success: function ( response ) {
                                    if (response && response.billing ) {
                                        $.each(
                                            response.billing, function ( key, data ) {
                        ...
                        $.ajax(
                            {
                                ...
                                success: function ( response ) {
                                    if (response && response.billing ) {
                                        $.each(
                                            response.shipping, function ( key, data ) {
        ...
        var wc_meta_boxes_order_items = {
            init: function () {
                ...
                // Subtotal/total
                .on(
                    'keyup change', '.split-input :input', function () {
                ...
                .on(
                    'keyup', '.split-input :input', function () {
            ...
            refund_items: function () {
                ...
                window.wcTracks.recordEvent(
                    'order_edit_refund_button_click', {
                        order_id: woocommerce_admin_meta_boxes.post_id,
                        status: $('#order_status').val()
                    } 
                );
            ...
            cancel: function () {
                ...
                window.wcTracks.recordEvent(
                    'order_edit_add_items_cancelled', {
                        order_id: woocommerce_admin_meta_boxes.post_id,
                        status: $('#order_status').val()
                    } 
                );
            ...
            backbone: {
                ...
                init: function ( e, target ) {
                    if ('wc-modal-add-products' === target ) {
                        ...
                        $(this).on(
                            'change', '.wc-product-search', function () {
        ...
        var wc_meta_boxes_order_notes = {
            ...
            delete_order_note: function () {
                if (window.confirm(woocommerce_admin_meta_boxes.i18n_delete_note) ) {
                            ...
                            $.post(
                                woocommerce_admin_meta_boxes.ajax_url, data, function () {
                                    $(note).remove();
                                }
                            );
                }
