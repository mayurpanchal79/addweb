...
( function ( $, params, wp ) {
    $(
        function () {
            // Sell Countries
            $('select#woocommerce_allowed_countries').change(
                function () {
            ...
            // Ship Countries
            $('select#woocommerce_ship_to_countries').change(
                function () {
                    if ('specific' === $(this).val() ) {
                        $(this).closest('tr').next('tr').show();
                    } else {
            ...
            // Stock management
            $('input#woocommerce_manage_stock').change(
                function () {
                    if ($(this).is(':checked') ) {
            ...
            // Re-order buttons.
            $('.wc-item-reorder-nav').find('.wc-move-up, .wc-move-down').on(
                'click', function () {
                    var moveBtn = $(this),
            ...
            $('.wc-item-reorder-nav').closest('table').on(
