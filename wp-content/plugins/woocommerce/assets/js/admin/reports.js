        ...
        $('.export_csv').click(
            function () {
                ...
                if ('table' === export_format ) {
                    ...
                    $(this).offsetParent().find('thead tr,tbody tr').each(
                        function () {
                    ...
                    $(this).offsetParent().find('tfoot tr').each(
                        function () {
                            $(this).find('th, td').each(
                                function () {
                                    var value = $(this).text();
                    ...
                    $.each(
                        the_series, function ( index, value ) {
