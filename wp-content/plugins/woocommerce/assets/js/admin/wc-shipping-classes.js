            ...
            ShippingClass       = Backbone.Model.extend(
                {
                    ...
                    save: function () {
                        if (_.size(this.changes) ) {
                            $.post(
                                ajaxurl + ( ajaxurl.indexOf('?') > 0 ? '&' : '?' ) + 'action=woocommerce_shipping_classes_save_changes', {
            ...
            ShippingClassView = Backbone.View.extend(
                {
                    ...
                    render: function () {
                        ...
                        if (_.size(classes) ) {
                              // Sort classes
                            classes = _.sortBy(
                                classes, function ( shipping_class ) {
