            ...
            WCTaxTableViewConstructor = Backbone.View.extend(
                {
                    ...
                    render: function () {
                        ...
                        if (paged_rates.length ) {
                            ...
                            $.each(
                                paged_rates, function ( id, rowData ) {
                        ...
                        this.$el.find('td.postcode input, td.city input').change(
                            function () {
                        ...
                        if ($current.length ) {
                            ...
                            rates_to_reorder = _.filter(
                                rates, function ( rate ) {
                                    ...
                                    reordered_rates = _.map(
                                        rates_to_reorder, function ( rate ) {
                                            rate.tax_rate_order++;
                    ...
                    onExport: function ( event ) {
                        ...
                        $.each(
                            event.data.view.model.getFilteredRates(), function ( id, rowData ) {
                                 var row = '';
