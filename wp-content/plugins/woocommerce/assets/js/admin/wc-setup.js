    ...
    function ( $ ) {
        ...
        $('form.address-step').on(
            'submit', function ( e ) {
                ...
                $(document.body).on(
                    'wc_backbone_modal_response', function () {
                        form.unbind('submit').submit();
                    } 
                );

                $('#wc_tracker_checkbox_dialog').on(
                    'change', function ( e ) {
        ...
        $('.wc-wizard-services').on(
            'change', '.wc-wizard-service-enable input', function () {
                if ($(this).is(':checked') ) {
        ...
        $('.wc-wizard-services').on(
            'click', '.wc-wizard-service-enable', function ( e ) {
                var eventTarget = $(e.target);
        ...
        $('.wc-wizard-services-list-toggle').on(
            'click', function () {
        ...
        $('.wc-wizard-services').on(
            'change', '.wc-wizard-shipping-method-select .method', function ( e ) {
        ...
        $('.wc-wizard-services').on(
            'change', '.wc-wizard-shipping-method-enable', function () {
        ...
        $('.wc-wizard-services').on(
            'change', 'input#stripe_create_account, input#ppec_paypal_reroute_requests', function () {
                if ($(this).is(':checked') ) {
        ...
        function addPlugins( bySlug, $el, hover )
        {
            ...
            for ( var i in Array.isArray(plugins) ? plugins : [] ) {
                ...
                bySlug[ slug ].find('a')
                .on(
                    'mouseenter mouseleave', ( function ( $hover, event ) {
        ...
        function updatePluginInfo()
        {
            ...
            $('.recommended-item input:checked').each(
                function () {
