        ...
        function () {
            ...
            function addURLParameters( context, url )
            {
                ...
                var utmSource = _.findKey(
                    sourceContextMap, function ( sourceInfo ) {
            ...
            function getRelevantPromotions( marketplaceSuggestionsApiData, displayContext )
            {
                ...
                var promos = _.filter(
                    marketplaceSuggestionsApiData, function ( promo ) {
            ...
            function displaySuggestions( marketplaceSuggestionsApiData )
            {
                ...
                $('.marketplace-suggestions-container').each(
                    function () {
                        ...
                        $('ul.product_data_tabs li.marketplace-suggestions_options a').click(
                            function ( e ) {
                                e.preventDefault();
