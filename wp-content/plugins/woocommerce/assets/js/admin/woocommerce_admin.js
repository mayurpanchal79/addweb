...
( function ( $, woocommerce_admin ) {
    $(
        function () {
            ...
            .on(
                'wc_add_error_tip', function ( e, element, error_type ) {
            ...
            .on(
                'wc_remove_error_tip', function ( e, element, error_type ) {
                    element.parent().find('.wc_error_tip.' + error_type).fadeOut(
                        '100', function () {
                            $(this).remove(); }
                    );
                }
            ...
            .on(
                'blur', '.wc_input_decimal[type=text], .wc_input_price[type=text], .wc_input_country_iso[type=text]', function () {
                    $('.wc_error_tip').fadeOut(
                        '100', function () {
                            $(this).remove(); }
                    );
            ...
            .on(
                'change', '#_sale_price.wc_input_price[type=text], .wc_input_price[name^=variable_sale_price]', function () {
            ...
            .on(
                'keyup', '#_sale_price.wc_input_price[type=text], .wc_input_price[name^=variable_sale_price]', function () {
                    var sale_price_field = $(this), regular_price_field;
            ...
            $('.wc_input_table.sortable tbody input').on(
                'click', function () {
                    $(this).focus();
                } 
            );

            $('.wc_input_table .remove_rows').click(
                function () {
            ...
            $(document.body).on(
                'click', '.show_order_items', function () {
            ...
            // Reviews.
            $('input#woocommerce_enable_reviews').change(
                function () {
                    if ($(this).is(':checked') ) {
            ...
            $('.wc_gateways').on(
                'click', '.wc-payment-gateway-method-toggle-enabled', function () {
                    var $link   = $(this),
                    $row    = $link.closest('tr'),
            ...
            $('#wpbody').on(
                'click', '#doaction, #doaction2', function () {
