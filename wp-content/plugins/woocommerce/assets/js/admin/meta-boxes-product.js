...
jQuery(
    function ( $ ) {
        ...
        $(
            function () {
                $('[id$="-all"] > ul.categorychecklist').each(
                    function () {
                        var $list = $(this);
        ...
        // Catalog Visibility.
        $('#catalog-visibility').find('.edit-catalog-visibility').click(
            function () {
        ...
        $('#catalog-visibility').find('.save-post-visibility').click(
            function () {
        ...
        $('#catalog-visibility').find('.cancel-post-visibility').click(
            function () {
                $('#catalog-visibility-select').slideUp('fast');
                $('#catalog-visibility').find('.edit-catalog-visibility').show();
        ...
        $('input#_downloadable, input#_virtual').change(
            function () {
                show_and_hide_panels();
            }
        );
        ...
        function show_and_hide_panels()
        {
            ...
            $.each(
                woocommerce_admin_meta_boxes.product_types, function ( index, value ) {
        ...
        // Sale price schedule.
        $('.sale_price_dates_fields').each(
            function () {
                var $these_sale_dates = $(this);
                var sale_schedule_set = false;
                var $wrap = $these_sale_dates.closest('div, table');

                $these_sale_dates.find('input').each(
                    function () {
                        if ('' !== $(this).val() ) {
        ...
        $('#woocommerce-product-data').on(
            'click', '.cancel_sale_schedule', function () {
                var $wrap = $(this).closest('div, table');
        ...
        // File inputs.
        $('#woocommerce-product-data').on(
            'click','.downloadable_files a.insert', function () {
                $(this).closest('.downloadable_files').find('tbody').append($(this).data('row'));
                return false;
            }
        );
        $('#woocommerce-product-data').on(
            'click','.downloadable_files a.delete',function () {
        ...
        woocommerce_attribute_items.sort(
            function ( a, b ) {
        ...
        $(woocommerce_attribute_items).each(
            function ( index, el ) {
        ...
        $('button.add_attribute').on(
            'click', function () {
                ...
                $.post(
                    woocommerce_admin_meta_boxes.ajax_url, data, function ( response ) {
        ...
        $('.product_attributes').on(
            'blur', 'input.attribute_name', function () {
                $(this).closest('.woocommerce_attribute').find('strong.attribute_name').text($(this).val());
            }
        );

        $('.product_attributes').on(
            'click', 'button.select_all_attributes', function () {
        ...
        $('.product_attributes').on(
            'click', 'button.select_no_attributes', function () {
        ...
        $('.product_attributes').on(
            'click', 'button.add_new_attribute', function () {
                    ...
                    woocommerce_admin_meta_boxes.ajax_url, data, function ( response ) {
                        if (response.error ) {
                            ...
                            $('#variable_product_options').load(
                                this_page + ' #variable_product_options_inner', function () {
        ...
        $(document.body).on(
            'click', '.upload_file_button', function ( event ) {
                var $el = $(this);
        ...
        $product_images.sortable(
            {
                ...
                update: function () {
                    ...
                    $('#product_images_container').find('ul li.image').css('cursor', 'default').each(
                        function () {
