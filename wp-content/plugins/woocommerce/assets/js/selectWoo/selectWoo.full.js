        ...
        S2.define(
            ...
            './utils'
                ...
                Results.prototype.bind = function (container, $container) {
                    ...
                    this.$results.on(
                        'mouseup', '.select2-results__option[data-selected]',
                        function (evt) {
                            var $this = $(this);
                    ...
                    this.$results.on(
                        'mouseenter', '.select2-results__option[data-selected]',
                        function (evt) {
                            var data = $(this).data('data');
            ...
            'jquery'
                ...
                InitSelection.prototype.current = function (decorated, callback) {
                    ...
                    this.initSelection.call(
                        null, this.$element, function (data) {
        ...
        S2.define(
            'select2/dropdown/stopPropagation',[
                ...
                StopPropagation.prototype.bind = function (decorated, container, $container) {
                    ...
                    this.$dropdown.on(
                        stoppedEvents.join(' '), function (evt) {
                            evt.stopPropagation();
                        }
                    );
                };
