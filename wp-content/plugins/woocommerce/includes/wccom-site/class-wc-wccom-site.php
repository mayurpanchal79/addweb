...
class WC_WCCOM_Site
{
    ...
    protected static function includes()
    {
        ...
        include_once WC_ABSPATH . 'includes/wccom-site/class-wc-wccom-site-installer.php';
        include_once WC_ABSPATH . 'includes/wccom-site/class-wc-wccom-site-installer-requirements-check.php';
    }
    ...
    {
        include_once WC_ABSPATH . 'includes/wccom-site/rest-api/class-wc-rest-wccom-site-installer-errors.php';
        include_once WC_ABSPATH . 'includes/wccom-site/rest-api/endpoints/class-wc-rest-wccom-site-installer-controller.php';
