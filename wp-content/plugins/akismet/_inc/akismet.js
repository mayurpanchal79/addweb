jQuery(
    function ( $ ) {
        ...
        $('#the-comment-list').on(
            'click', '.akismet_remove_url', function () {
                var thisId = $(this).attr('commentid');
                var data = {
            ...
            'click', '.akismet_undo_link_removal', function () {
        ...
        if ("enable_mshots" in WPAkismet && WPAkismet.enable_mshots ) {
            $('#the-comment-list').on(
                'mouseover', mshotEnabledLinkSelector, function () {
                ...
                'mouseout', 'a[id^="author_comment_url"], tr.pingback td.column-author a:first-of-type, td.comment p a', function () {
        ...
        $('.checkforspam.enable-on-load').click(
            function ( e ) {
         ...
         */
        $('.akismet-enter-api-key-box a').on(
            'click', function ( e ) {
                e.preventDefault();
