...
class Migration_Command extends WP_CLI_Command
{
    ...
    public function register()
    {
        ...
        WP_CLI::add_command(
            'action-scheduler migrate', [ $this, 'migrate' ], [
