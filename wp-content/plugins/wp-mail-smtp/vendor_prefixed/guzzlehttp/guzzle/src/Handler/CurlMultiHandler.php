...
class CurlMultiHandler
{
    ...
    {
        $this->factory = isset($options['handle_factory']) ? $options['handle_factory'] : new \WPMailSMTP\Vendor\GuzzleHttp\Handler\CurlFactory(50);
    ...
    public function tick()
    {
        ...
        \WPMailSMTP\Vendor\GuzzleHttp\Promise\queue()->run();
    ...
    {
        $queue = \WPMailSMTP\Vendor\GuzzleHttp\Promise\queue();
