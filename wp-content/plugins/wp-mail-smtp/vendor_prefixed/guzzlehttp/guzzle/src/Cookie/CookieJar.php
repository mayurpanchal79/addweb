...
class CookieJar implements \WPMailSMTP\Vendor\GuzzleHttp\Cookie\CookieJarInterface
{
    ...
    public function extractCookies(\WPMailSMTP\Vendor\Psr\Http\Message\RequestInterface $request, \WPMailSMTP\Vendor\Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function withCookieHeader(\WPMailSMTP\Vendor\Psr\Http\Message\RequestInterface $request)
    {
        $values = [];
        $uri = $request->getUri();
     ...
     */
    private function removeCookieIfEmpty(\WPMailSMTP\Vendor\GuzzleHttp\Cookie\SetCookie $cookie)
    {
