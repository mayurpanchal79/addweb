...
WPMailSMTP.Admin.Settings = WPMailSMTP.Admin.Settings || ( function ( document, window, $ ) {
    ...
    var app = {
        ...
        bindActions: function () {
            ...
            // Mailer selection.
            $('.wp-mail-smtp-mailer-image', app.pageHolder).click(
                function () {
                    $(this).parents('.wp-mail-smtp-mailer').find('input').trigger('click');
                } 
            );

            $('.wp-mail-smtp-mailer input', app.pageHolder).click(
                function () {
                    var $input = $(this);
            ...
            $('#wp-mail-smtp-pro-banner-dismiss', app.pageHolder).on(
                'click', function () {
                    $.ajax(
                        {
                            url: ajaxurl,
            ...
            $('.js-wp-mail-smtp-mailer-notice-dismiss', app.pageHolder).on(
                'click', function ( e ) {
                    e.preventDefault();
            ...
            $('#wp-mail-smtp-debug .error-log-toggle').on(
                'click', function ( e ) {
                    e.preventDefault();
            ...
            $('.js-wp-mail-smtp-provider-remove', app.pageHolder).on(
                'click', function () {
            ...
            $('.wp-mail-smtp-setting-copy', app.pageHolder).click(
                function ( e ) {
                    e.preventDefault();
        ...
        mailers: {
            smtp: {
                bindActions: function () {
                    ...
                    $('#wp-mail-smtp-setting-smtp-auth').change(
                        function () {
                    ...
                    $('#wp-mail-smtp-setting-row-smtp-encryption input').change(
                        function () {
        ...
        triggerExitNotice: function () {
            ...
            $(':input:not( #wp-mail-smtp-setting-license-key, .wp-mail-smtp-not-form-input )', $settingPages).on(
                'change', function () {
