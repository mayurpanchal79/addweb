...
if(false !== getenv('WP_TESTS_DIR') ) {
    include getenv('WP_TESTS_DIR') . '/includes/bootstrap.php';
} else {
    include dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))) . '/tests/phpunit/includes/bootstrap.php';
}
