...
class MailChimp_WooCommerce_Rest_Api
{
    ...
    public function register_routes()
    {
        ...
        register_rest_route(
            static::$namespace, "/survey/disconnect", array(
            'methods' => 'POST',
        ...
        // Sync Stats
        register_rest_route(
            static::$namespace, '/sync/stats', array(
            'methods' => 'GET',
        ...
        register_rest_route(
            static::$namespace, "/review-banner", array(
            'methods' => 'GET',
