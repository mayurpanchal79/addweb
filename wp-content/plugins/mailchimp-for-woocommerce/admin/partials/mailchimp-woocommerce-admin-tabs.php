    ...
    <?php if($show_wizard) : ?>  
        <div class="nav-wizard-wrapper">
            <div class="wizard-tab <?php echo $active_tab == 'api_key' ? 'wizard-tab-active' : ''; ?>" >
                ...
                <div class="wizard-tab-tooltip wizard-tab-tooltip-api-key "><?php echo esc_html_e('Connect', 'mailchimp-for-woocommerce');?>
            ...
            <?php if ($has_valid_api_key) : ?>    
                <div class="wizard-tab <?php echo $active_tab == 'store_info' ? 'wizard-tab-active' : ''; ?>">
                    ...
                    <div class="wizard-tab-tooltip wizard-tab-tooltip-store-info "><?php echo esc_html_e('Store Settings', 'mailchimp-for-woocommerce');?>
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="14.498" width="20" height="20" transform="rotate(45 14.498 0)" fill="white"/>
                        </svg>
                    </div>
            ...
            <?php if ($handler->hasValidStoreInfo() && $show_campaign_defaults && $this->getData('validation.store_info', false)) : ?>  
                <div class="wizard-tab <?php echo $active_tab == 'campaign_defaults' ? 'wizard-tab-active' : ''; ?>">
                    ...
                    <div class="wizard-tab-tooltip wizard-tab-tooltip-store-info "><?php echo esc_html_e('Audience Defaults', 'mailchimp-for-woocommerce');?>
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="14.498" width="20" height="20" transform="rotate(45 14.498 0)" fill="white"/>
                        </svg>
                    </div>
            ...
            <?php if ($handler->hasValidCampaignDefaults() && $this->getData('validation.campaign_defaults', false)) : ?>  
                <div class="wizard-tab <?php echo $active_tab == 'newsletter_settings' ? 'wizard-tab-active' : ''; ?>">
                    ...
                    <div class="wizard-tab-tooltip wizard-tab-tooltip-store-info "><?php echo esc_html_e('Audience Settings', 'mailchimp-for-woocommerce');?>
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="14.498" width="20" height="20" transform="rotate(45 14.498 0)" fill="white"/>
                        </svg>
                    </div>
        ...
        <div class="nav-tab-wrapper">
            <?php if($has_valid_api_key) : ?>
                <?php if ($active_tab == 'api_key') : ?>
                    <a href="?page=mailchimp-woocommerce&tab=api_key" class="nav-tab <?php echo $active_tab == 'api_key' ? 'nav-tab-active' : ''; ?>"><?php echo esc_html_e('Connect', 'mailchimp-for-woocommerce');?></a>
                <?php endif ;?>
                <a href="?page=mailchimp-woocommerce&tab=sync" class="nav-tab <?php echo $active_tab == 'sync' ? 'nav-tab-active' : ''; ?>"><?php echo esc_html_e('Overview', 'mailchimp-for-woocommerce');?></a>
                <a href="?page=mailchimp-woocommerce&tab=store_info" class="nav-tab <?php echo $active_tab == 'store_info' ? 'nav-tab-active' : ''; ?>"><?php echo esc_html_e('Store Settings', 'mailchimp-for-woocommerce');?></a>
                <?php if ($handler->hasValidStoreInfo()) : ?>
                    <?php if($show_campaign_defaults) : ?>
                        <a href="?page=mailchimp-woocommerce&tab=campaign_defaults" class="nav-tab <?php echo $active_tab == 'campaign_defaults' ? 'nav-tab-active' : ''; ?>"><?php echo esc_html_e('Audience Defaults', 'mailchimp-for-woocommerce');?></a>
                    <?php endif; ?>
                    <?php if($handler->hasValidCampaignDefaults()) : ?>
                        <a href="?page=mailchimp-woocommerce&tab=newsletter_settings" class="nav-tab <?php echo $active_tab == 'newsletter_settings' ? 'nav-tab-active' : ''; ?>"><?php echo esc_html_e('Audience Settings', 'mailchimp-for-woocommerce');?></a>
                    <?php endif; ?>
                <?php endif;?>
                <a href="?page=mailchimp-woocommerce&tab=logs" class="nav-tab <?php echo $active_tab == 'logs' ? 'nav-tab-active' : ''; ?>"><?php echo esc_html_e('Logs', 'mailchimp-for-woocommerce');?></a>
            <?php endif; ?>
        </div> 
    <?php endif; ?>
