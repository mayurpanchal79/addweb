...
<div id="mc-woocommerce-create-account" class="mc-woocommerce-modal">
    <div id="exampleModal" class="reveal-modal">
        ...
        <div id="mc-woocommerce-create-account-step-1" class="mc-woocommerce-create-account-step">
                ...
                <input id="first_name" name="first_name" type="hidden" value="<?php echo get_user_meta($user_id, 'first_name', true);?>">    
                <input id="last_name" name="last_name" type="hidden" value="<?php echo get_user_meta($user_id, 'last_name', true);?>">    
                ...
                <div class="box box-half" >                    
                    ...
                    <div class="mailchimp-select-wrapper">
                        ...
                        woocommerce_form_field(
                            $this->plugin_name.'[store_country]', array(
                            'type'          => 'select',
                            'id'            => 'country',
                ...
                <div class="box terms" >
                    <p>
                        <?php 
                            ...
                            ?>
                        <?php echo sprintf(/* translators: %s - Mailchimp legal pages */wp_kses(__('By clicking the "Get Started!" button, you are creating a Mailchimp account, and you agree to Mailchimp\'s <a href=%1$s target=_blank>Terms of Use</a> and <a href=%2$s target=_blank>Privacy Policy</a>.', 'mailchimp-for-woocommerce'), array(  'a' => array( 'href' => array(), 'target'=> '_blank' ) )), esc_url('https://mailchimp.com/legal/terms'), esc_url('https://mailchimp.com/legal/privacy'));?>
