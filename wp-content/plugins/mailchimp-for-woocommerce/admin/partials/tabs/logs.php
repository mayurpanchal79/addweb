...
<fieldset>
    ...
    <div class="box log-file-actions">
        ...
        <div id="log-actions">
            <?php if (! empty($handle) ) : ?>
                <a class="mc-woocommerce-log-button mc-woocommerce-copy-log-button" title="<?php echo __('Copy Log to clipboard', 'mailchimp-for-woocommerce');?>" href="#">
                ...
                <a class="mc-woocommerce-log-button delete-log-button" title="<?php echo __('Delete Log', 'mailchimp-for-woocommerce');?>" href="<?php echo esc_url(wp_nonce_url(add_query_arg(array( 'handle' => sanitize_title($viewed_log) ), admin_url('admin.php?page=mailchimp-woocommerce&tab=logs&mc_action=remove_log')), 'remove_log')); ?>">
